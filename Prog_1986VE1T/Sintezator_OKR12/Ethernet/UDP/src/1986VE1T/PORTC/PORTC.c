...
// 
	...
	PORTC->RXTX = 0x0000;
	PORTC->ANALOG = 0x0000|(1<<2)|(0x3<<3)|(0x3<<13)|(1<<15)|(1<<9)|(1<<11); //режим работы - цифровой , ставим еденички для уартов 1 и 2 и выхода PC[2],сигнал ADR, 
	PORTC->PWR = 0xffffffff;
    
    PORTC->OE   =0x0000;
	PORTC->OE  |=(1<<15)|(1<<2)|(1<<9)|(1<<11);				// сигнал ТНИ и ТНП,сигнал ADR, сигнал DTAA , Направление порта. 1 - выход, 0 - вход. 
	PORTC->PD   =0x0000;
