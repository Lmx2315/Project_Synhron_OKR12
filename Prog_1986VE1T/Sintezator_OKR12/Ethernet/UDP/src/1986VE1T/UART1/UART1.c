...
{
#ifdef REVISION_2
	UART1->IBRD = 0x000D;	// speed of UART1 = 115200 bit/s, Целая часть делителя скорости обмена данными
	UART1->FBRD = 0x0024;	// speed of UART1 = 115200 bit/s, Дробная часть делителя скорости обмена данными
#else
	UART1->IBRD = 0x000D;	// speed of UART1 = 115200 bit/s
	UART1->FBRD = 0x0001;	// speed of UART1 = 115200 bit/s
#endif	//REVISION_2
	UART1->LCR_H = 0x0060; // Регистр управления линией 8-bits word, FIFO enable, parity disable, 1 stop bit

// UART1->LCR_H - Регистр управления линией
// ╔═════════╦════════════════╦════════════════════════════════════════════════════════════════════════════════════╗
...
// ╚═════════╩════════════════╩════════════════════════════════════════════════════════════════════════════════════╝
	...
	UART1->CR = 0x0301;    // Регистр управления. UART1, Tx, Rx enable
	
// UART1->CR - Регистр управления
// ╔═════════╦════════════════╦════════════════════════════════════════════════════════════════════════════════════╗
// ║ 	 Биты  ║ Поле           ║                 Назначение                                                         ║
// ╠═════════╬════════════════╬════════════════════════════════════════════════════════════════════════════════════╣
